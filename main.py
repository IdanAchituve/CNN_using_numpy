...
nn_params["conv_num_layers"] = [3, 8, 16]  # number of feature maps to create in each convolution operation. Must start with 3
...
nn_params["layers"] = [4096, 15, 10]  # FC dims - 1st dim is the flattening of the final conv/pol layers
