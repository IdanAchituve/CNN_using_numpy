...
nn_params["conv_num_layers"] = [3, 4, 5]  # number of feature maps to create in each convolution operation. Must start with 3
...
nn_params["layers"] = [1280, 20, 10]  # FC dims - 1st dim is the flattening of the final conv/pol layers
